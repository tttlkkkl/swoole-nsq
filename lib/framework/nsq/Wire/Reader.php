...
use lib\framework\nsq\Connection\ConnectionInterface;
use lib\framework\nsq\Message\Message;
use lib\framework\nsq\Exception\SocketException;
use lib\framework\nsq\Exception\ReadException;
use lib\framework\nsq\Exception\ErrorFrameException;
use lib\framework\nsq\Exception\ResponseFrameException;
use lib\framework\nsq\Exception\UnknownFrameException;
